...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lift_exercisedata', (
            ...
            ('data', self.gf('json_field.fields.JSONField')(default='{}', max_length=1000)),
        ))
        ...
        db.create_table(u'lift_exercisedef', (
            ...
            ('video_url', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
            ('algorithm', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('options', self.gf('json_field.fields.JSONField')(default='{}', max_length=1000)),
        ))
    ...
    models = {
        ...
        u'lift.exercisedata': {
            ...
            'data': ('json_field.fields.JSONField', [], {'default': "'{}'", 'max_length': '1000'}),
        ...
        u'lift.exercisedef': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'options': ('json_field.fields.JSONField', [], {'default': "'{}'", 'max_length': '1000'}),
